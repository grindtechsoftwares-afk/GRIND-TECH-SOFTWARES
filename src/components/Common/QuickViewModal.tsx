...
“Get Lifetime license software, Free Support, and Hassle-Free Installation!”
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button
                  disabled={quantity === 0 && true}
                  onClick={() => {
                 window.location.href = "https://drive.google.com/uc?export=view&id=1eaNBZC806JFtL0vx0azBEca8iVReM09b"; 
                 }}
                  className={`inline-flex font-medium text-white bg-blue py-3 px-7 rounded-md ease-out duration-200 hover:bg-blue-dark`}>

                  BUY NOW
                </button>
                <button disabled={quantity === 0 && true}
                  onClick={() => {
                 window.location.href = "https://www.tiktok.com/@grindtech0?is_from_webapp=1&sender_device=pc"; 
                 }}
